// tvm target: c -keys=cpu -constants-byte-alignment=16 -mcpu=generic-rv32 -model=etiss-rv32im -workspace-byte-alignment=16
#define TVM_EXPORTS
  ...
  for (int32_t i0_i1_fused_i2_fused = 0; i0_i1_fused_i2_fused < 29; ++i0_i1_fused_i2_fused) {
    for (int32_t i3 = 0; i3 < 25; ++i3) {
      for (int32_t i4 = 0; i4 < 16; ++i4) {
        ...
        int16_t condval;
        if (((((2 <= i0_i1_fused_i2_fused) && (i0_i1_fused_i2_fused < 26)) && (2 <= i3)) && (i3 < 22))) {
          condval = p0[((((i0_i1_fused_i2_fused * 320) + cse_var_1) + i4) - 672)];
        } else {
          condval = (int16_t)0;
        }
        ((int16_t*)data_pad_let)[(((i0_i1_fused_i2_fused * 400) + cse_var_1) + i4)] = condval;
      }
    }
  }
  ...
  for (int32_t i0_i1_fused_i2_fused = 0; i0_i1_fused_i2_fused < 15; ++i0_i1_fused_i2_fused) {
    for (int32_t i3 = 0; i3 < 13; ++i3) {
      for (int32_t i4 = 0; i4 < 12; ++i4) {
        ...
        int16_t condval;
        if (((((1 <= i0_i1_fused_i2_fused) && (i0_i1_fused_i2_fused < 13)) && (1 <= i3)) && (i3 < 11))) {
          condval = p0[((((i0_i1_fused_i2_fused * 120) + cse_var_1) + i4) - 132)];
        } else {
          condval = (int16_t)0;
        }
        ((int16_t*)data_pad_let)[(((i0_i1_fused_i2_fused * 156) + cse_var_1) + i4)] = condval;
      }
    }
  }
...
TVM_DLL int32_t tvmgen_default_fused_nn_contrib_conv2d_NCHWc_add_fixed_point_multiply_per_axis_add_clip_cast(int16_t* p0, int8_t* T_cast, uint8_t* global_const_workspace_4_var, uint8_t* global_workspace_5_var) {
  ...
  for (int32_t i0_i1_fused_i2_fused = 0; i0_i1_fused_i2_fused < 56; ++i0_i1_fused_i2_fused) {
    for (int32_t i3 = 0; i3 < 47; ++i3) {
      int16_t condval;
      if (((((3 <= i0_i1_fused_i2_fused) && (i0_i1_fused_i2_fused < 52)) && (3 <= i3)) && (i3 < 43))) {
        condval = p0[(((i0_i1_fused_i2_fused * 40) + i3) - 123)];
      } else {
        condval = (int16_t)0;
      }
      ((int16_t*)data_pad_let)[((i0_i1_fused_i2_fused * 47) + i3)] = condval;
    }
  }
...
TVM_DLL int32_t tvmgen_default_fused_nn_dense_add_fixed_point_multiply_add_clip_cast(int16_t* p0, int8_t* T_cast, uint8_t* global_const_workspace_22_var, uint8_t* global_workspace_23_var) {
  ...
  for (int32_t ax1 = 0; ax1 < 32; ++ax1) {
    int32_t v_ = ((int32_t)(((((0 != 0) ? (((int64_t)(((int32_t*)compute_let_1)[ax1] + ((int32_t*)fused_nn_dense_constant_let)[ax1])) << ((int64_t)0)) : ((int64_t)(((int32_t*)compute_let_1)[ax1] + ((int32_t*)fused_nn_dense_constant_let)[ax1]))) * (int64_t)1483316438) + ((int64_t)1 << ((int64_t)((7 + 31) - 1)))) >> ((int64_t)(7 + 31)))) - 128;
    int32_t v__1 = (v_) < (127) ? (v_) : (127);
...
TVM_DLL int32_t tvmgen_default_fused_nn_dense_add_fixed_point_multiply_add_clip_cast_1(int16_t* p0, int8_t* T_cast, uint8_t* global_const_workspace_26_var, uint8_t* global_workspace_27_var) {
  ...
  for (int32_t ax1 = 0; ax1 < 16; ++ax1) {
    int32_t v_ = ((int32_t)(((((0 != 0) ? (((int64_t)(((int32_t*)compute_let_1)[ax1] + ((int32_t*)fused_nn_dense_constant_1_let)[ax1])) << ((int64_t)0)) : ((int64_t)(((int32_t*)compute_let_1)[ax1] + ((int32_t*)fused_nn_dense_constant_1_let)[ax1]))) * (int64_t)1321827316) + ((int64_t)1 << ((int64_t)((7 + 31) - 1)))) >> ((int64_t)(7 + 31)))) - 128;
    int32_t v__1 = (v_) < (127) ? (v_) : (127);
    T_cast[ax1] = ((int8_t)((v__1) > (-128) ? (v__1) : (-128)));
  }
  return 0;
...
TVM_DLL int32_t tvmgen_default_fused_nn_dense_add_fixed_point_multiply_add_clip_subtract_cast_multiply(int16_t* p0, float* T_multiply, uint8_t* global_const_workspace_30_var, uint8_t* global_workspace_31_var) {
  ...
  for (int32_t ax1 = 0; ax1 < 10; ++ax1) {
    int32_t v_ = ((int32_t)(((((0 != 0) ? (((int64_t)(((int32_t*)compute_let_1)[ax1] + ((int32_t*)fused_nn_dense_constant_2_let)[ax1])) << ((int64_t)0)) : ((int64_t)(((int32_t*)compute_let_1)[ax1] + ((int32_t*)fused_nn_dense_constant_2_let)[ax1]))) * (int64_t)1349453042) + ((int64_t)1 << ((int64_t)((7 + 31) - 1)))) >> ((int64_t)(7 + 31)))) + 34;
    int32_t v__1 = (v_) < (127) ? (v_) : (127);
    T_multiply[ax1] = (((float)(((v__1) > (-128) ? (v__1) : (-128)) - 34)) * 2.875707e-01f);
  }
  return 0;
}
  ...
  for (int32_t ax0_ax1_fused_ax2_fused = 0; ax0_ax1_fused_ax2_fused < 384; ++ax0_ax1_fused_ax2_fused) {
    for (int32_t ax3 = 0; ax3 < 20; ++ax3) {
      ...
      for (int32_t rv0_rv1_fused = 0; rv0_rv1_fused < 4; ++rv0_rv1_fused) {
        ...
        int8_t v_ = ((int8_t*)pool_max_let)[cse_var_1];
        int8_t v__1 = p0[((((((ax0_ax1_fused_ax2_fused / 24) * 1960) + ((ax0_ax1_fused_ax2_fused % 24) * 80)) + ((rv0_rv1_fused >> 1) * 40)) + (ax3 * 2)) + (rv0_rv1_fused & 1))];
        ((int8_t*)pool_max_let)[cse_var_1] = ((v_) > (v__1) ? (v_) : (v__1));
      }
    }
  }
  for (int32_t ax0_ax1_fused = 0; ax0_ax1_fused < 16; ++ax0_ax1_fused) {
